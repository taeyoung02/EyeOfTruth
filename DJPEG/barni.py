...
from extract_dct import DCT_basis_torch


class barni(nn.Module):
    def __init__(self):
        super(barni, self).__init__()
        ...
        # 아핀연산 y = Wx + b
        # 15x8x256+64
        self.fc1 = nn.Linear(15 * 8 * 256, 500)
        self.fc2 = nn.Linear(500, 500)  # bias =64
    ...
    def forward(self, x):
        ...
        with torch.no_grad():
            ...
            x = F.conv2d(x, weight=self.dct_basis, stride=8)  # use dct_basis as filter
            # x.shape= (32,64,32,32)
